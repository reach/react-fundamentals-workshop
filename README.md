...
```sh
$ git clone https://github.com/ryanflorence/react-fundamentals.git
```

## Step 3 - Install an app

Each section is a separate app using [Create React App](https://github.com/facebookincubator/create-react-app).
